    ...
    def write_file(self, file):
        ...
        with codecs.open(file, 'r', encoding, errors='replace') as fp:
            for line in fp:
                ...
                if not blank_line and not comment_line:
                    lines_count += 1
                    if lines_count % 50 == 0:
...
def parse_args():
    ...
    parser.add_argument('--font_name', type=str, default='宋体', help='Font')
    parser.add_argument('--font_size', type=float, default=10.5, help='Font size')
    parser.add_argument('--space_before', type=float, default=0.0, help='space before')
    parser.add_argument('--space_after', type=float, default=2.3, help='space after')
    parser.add_argument('--line_spacing', type=float, default=10.5, help='line spacing')
    parser.add_argument('--outfile', type=str, default='code.docx', help='Output file')
